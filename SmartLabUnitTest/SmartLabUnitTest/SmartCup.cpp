...
int SmartCup::readWeatherSi7020()
{
	//1010 REMOVED/CHANGED FOR TESTING
	/*
	Si70xx si7020;
...
void SmartCup::readSi1132Sensor()
{
	//1010 REMOVED/CHANGED FOR TESTING
	/*
...
int SmartCup::getMinute()
{
	return minute;
}

int SmartCup::digitalRead()
{
	return motion;
}

void SmartCup::setTemperature(float newTemperature)
{
	temperature = newTemperature;
}

void SmartCup::setHumidity(float newHumidity)
{
	humidity = newHumidity;
}

void SmartCup::setLight(float newLight)
{
	light = newLight;
}

void SmartCup::setSound(float newSound)
{
	soundLevel = newSound;
}

void SmartCup::setMotion(int newMotion)
{
	motion = newMotion;
}

void SmartCup::setMinute(int newMinute)
{
	if (newMinute >= 60)
		newMinute -= 60;
	minute = newMinute;
...
std::string SmartCup::getClientRequest(RestClient client)
{
	return client.getRequest();
}

void SmartCup::resetValues() {
	oldTmp = -50;
	oldHmd = -50;
	oldVisible = -50;
	oldSound = -50;
...
bool SmartCup::getSensorTriggered()
{
